...
local OrionLib = {
	...
	Themes = {
		Default = {
			...
			Stroke = Color3.fromRGB(5, 22, 252),
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Slowed Scripts"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Slowed Scripts"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://15837192551"
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://15837192551"
